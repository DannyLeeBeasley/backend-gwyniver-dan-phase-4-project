...
tube_screamer = Pedal.create(name: "Ibanez TS808 Tube Screamer", effect_type: "overdrive", price: 100, stereo: false, number_of_inputs: 1, number_of_outputs: 1, image: "https://m.media-amazon.com/images/I/713LJ9zI96L._AC_SS450_.jpg", category: "gain-staging")
ocd = Pedal.create(name: "Fulltone OCD V2", effect_type: "overdrive", price: 140, stereo: false, number_of_inputs: 1, number_of_outputs: 1, image: "https://cdn.shopify.com/s/files/1/2161/9961/products/Fulltone-effect-OCD.jpg?v=1520232597", category: "gain-staging")
...
cry_baby = Pedal.create(name: "Dunlop Cry Baby Standard Wah GCB95", effect_type: "wah-wah", price: 90, stereo: false, number_of_inputs: 1, number_of_outputs: 1, image: "https://i.ebayimg.com/images/g/NA4AAOSwzl9f6c5p/s-l640.jpg", category: "EQ/filter")
dyna_comp = Pedal.create(name: "MXR M-102 Dyna Comp Compressor", effect_type: "compressor", price: 80, stereo: false, number_of_inputs: 1, number_of_outputs: 1, image: "https://www.pitbullaudio.com/media/catalog/product/1/6/16001102001.main.jpg?quality=100&bg-color=255,255,255&fit=bounds&height=&width=", category: "gain-staging")
